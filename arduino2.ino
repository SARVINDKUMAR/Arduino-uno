...
const int trigPin1 = 11; //trigger output pin ( sensor 1 )
const int echoPin1 = 10; //echo input pin ( sensor 1 )     
const int trigPin2 = 6;  //trigger output pin ( sensor 2 ) 
const int echoPin2 = 5;  //echo input pin ( sensor 2 ) 
